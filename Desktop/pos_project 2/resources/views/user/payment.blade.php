                                    ...
                                    <div class="">
                                        <form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row mt-4">
                                                ...
                                                <div class="col">
                                                    <input type="file" name="payslipImage" id="" value="{{ old('payslipImage') }}" class="form-control @error('payslipImage') is-invalid @enderror">
                                                    @error('payslipImage')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row mt-4">
                                                ...
                                                <div class="col">
                                                    <input type="hidden" name="totalAmount" value="{{ $orderTemp[0]['finalAmt'] }} mmk">
