                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="rounded text-center">
                                <a href="#">
                                    <img src="{{ asset('productImage/'.$product->image) }}" class="img-fluid rounded" alt="Image">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <h4 class="fw-bold h1 text-warning mb-3">{{ $product->name }}</h4>
                            <span class="text-danger mb-3 h5">( Only {{ $product->stock }} items left! )</span>
                            <p class="my-2">Category: {{ $product->category_name }}</p>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="rating-css">
                                                    <div class="star-icon">
                                                        ...
                                                        {{-- user who has never given ratings --}}
                                                        @if ($userRating == 0)
                        ...
                        <div class="col-lg-12">
                            <nav>
                                <div class="nav nav-tabs mb-3">
                                    ...
                                    id="nav-mission-tab" data-bs-toggle="tab" data-bs-target="#nav-mission" aria-controls="nav-mission" aria-selected="false">
                                    Customer Comments <span class=" btn btn-sm btn-secondary rounded shadow-sm">{{ count($comments) }}</span>
                                    </button>
                                </div>
                            </nav>
                            <div class="tab-content mb-5">
                                ...
                                <div class="tab-pane" id="nav-mission" role="tabpanel"
                                    ...
                                    @foreach ($comments as $item)
                                        <div class="d-flex">
                                            <img src="{{ asset( $item->profile == null ? 'picForDefault/adminProfile.webp' : 'profile/'.$item->profile ) }}"
                                            ...
                                            <div class="">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    @if($item->user_id == Auth::user()->id)
                                                        <button type="button" onclick="deleteProcess({{ $item->comment_id }})" class= "btn btn-sm btn-outline-danger rounded shadow-sm mx-4">
