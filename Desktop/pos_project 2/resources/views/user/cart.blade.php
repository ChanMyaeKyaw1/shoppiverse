                            ...
                            <tr>
                                <th scope="row">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('productImage/'.$item->image) }}" class="img-fluid me-5 rounded-circle" style="width: 80px; height: 80px;" alt="">
                                    </div>
                                </th>
                                <td>
                    ...
                    <div class="bg-light rounded">
                        <div class="p-4">
                            ...
                            <div class="d-flex justify-content-between mb-4">
                                <h5 class="mb-0 me-4" id="subTotal">Subtotal:</h5>
...
<script>
    $(document).ready(function() {
        ...
        function totalCalculation(event) {
        ...
        $(".btn-remove").click(function() {
            ...
            deleteData = {
                'cartId' : cartId  // key : value
            }

            // body ka nay data send tr
            $.ajax({
                type : 'get',
                url : '/user/cartDelete',
                data : deleteData,
    ...
    //     orderList = [];
    //     userId = $('.userId').val();
    //     orderCode = "CL-POS-" + Math.floor(Math.random() * 100000000000);
    ...
    //         // console.log($(row).find(".productId").val());
